...
Button(root,text="C",width=5,height=1,font=("arial",30,"bold"),bd=2,fg="#fff",bg="#FF6347",command=lambda: clear()).place(x=10,y=100)
Button(root,text="/",width=5,height=1,font=("arial",30,"bold"),bd=2,fg="#fff",bg="#2a2d36",command=lambda: show("/")).place(x=150,y=100)
...
Button(root,text="enter",width=5,height=3,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#FFA500",command=lambda:calculate()).place(x=430,y=400)
